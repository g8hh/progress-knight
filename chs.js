...
var cnRegReplace = new Map([
    ...
    [/^(\d+)\/(\d+), Immortality level (\d+)\/$/, '$1\/$2, 永生等级 $3\/'],
    [/^(\d+)\/(\d+), Mage level (\d+)\/$/, '$1\/$2, 法师等级 $3\/'],
    ...
    [/^(\d+)\/(\d+), Holy knight level (\d+)\/$/, '$1\/$2, 圣骑士等级 $3\/'],
    [/^(\d+)\/(\d+), Apprentice mage level (\d+)\/$/, '$1\/$2, 学徒法师等级 $3\/'],
    [/^(\d+)\/(\d+), Elite knight level (\d+)\/$/, '$1\/$2, 精英骑士等级 $3\/'],
    ...
    [/^(\d+)\/(.+), Battle tactics level (.+)\/$/, '$1/$2，战斗战术等级 $3\/'],
    [/^(\d+)\/(.+), Mage level (.+)\/$/, '$1/$2，法师等级 $3\/'],
    [/^(\d+)\/(.+), Battle tactics level (.+)\/(.+), Holy knight level (.+)\/$/, '$1/$2，战斗战术等级 $3\/$4，圣骑士等级 $5\/'],
    [/^(\d+) evil$/, '$1 邪恶'],
